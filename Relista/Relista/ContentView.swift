...
struct ContentView: View {
    ...
    var body: some View {
        UnifiedSplitView {
            ...
            ChatWindow(conversationID: $viewModel.selectedConversationID, inputMessage: $inputMessage, selectedAgent: $selectedAgent, selectedModel: $selectedModel, useSearch: $useSearch, useReasoning: $useReasoning)
                .toolbar(){
                    ToolbarItemGroup() {
